...
export default function WhatsAppSupport() {
  ...
  return (
    <section className="py-20 lg:py-32 bg-accent-soft/30 border-t border-foreground/5 scroll-mt-20">
          ...
          <div className="lg:col-span-5 flex justify-center lg:justify-end">
            <div className="w-full max-w-md bg-background rounded-[2.5rem] p-8 border border-foreground/5 shadow-2xl transition-all duration-500 hover:scale-[1.01] hover:shadow-primary/5 flex flex-col">
              ...
              <div className="flex flex-col gap-3">
                <a
                  href="https://wa.me/917898565432?text=Hello!%20I%20would%20like%20to%20order%20some%20Ayurvedic%20medicines%20to%20my%20home."
                  target="_blank"
